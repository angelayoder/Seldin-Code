...
boxplot(fin.r.squared_brain[,2], r.squared_brain_ts[,2], names = c("Not TS", "TS"), xlab = "R Squared", main = "R Squared Brain Data")
boxplot(fin.r.squared_liver[,2], r.squared_liver_ts[,2], names = c("Not TS", "TS"), xlab = "R Squared", main = "R Squared Liver Data")
