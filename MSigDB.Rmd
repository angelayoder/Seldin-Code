...
C2_genes = msigdbr(species = "Rattus norvegicus", category = "C2")
C5_genes = msigdbr(species = "Rattus norvegicus", category = "C5")
...
for (i in 1:5)
{
  ...
  out.brain_H[[i]] = data.frame(ID = listt$ID, Description = listt$Description, pvalue = listt$pvalue, p.adjust = listt$p.adjust, geneID = listt$geneID)
}

out.liver_H = list(c(), c(), c(), c(), c())
...
for (i in 1:5)
{
  ...
  entrez = na.omit(entrez)
  listt = enricher(gene = entrez, TERM2GENE = database, pAdjustMethod = "fdr")
  out.liver_H[[i]] = data.frame(ID = listt$ID, Description = listt$Description, pvalue = listt$pvalue, p.adjust = listt$p.adjust, geneID = listt$geneID)
}
...
for (i in 1:5)
{
  ...
  entrez = na.omit(entrez)
  listt = enricher(gene = entrez, TERM2GENE = database, pAdjustMethod = "fdr")
  out.brain_C2[[i]] = data.frame(ID = listt$ID, Description = listt$Description, pvalue = listt$pvalue, p.adjust = listt$p.adjust, geneID = listt$geneID)
}

out.liver_C2 = list(c(), c(), c(), c(), c())
...
for (i in 1:5)
{
  ...
  entrez = na.omit(entrez)
  listt = enricher(gene = entrez, TERM2GENE = database, pAdjustMethod = "fdr")
  out.liver_C2[[i]] = data.frame(ID = listt$ID, Description = listt$Description, pvalue = listt$pvalue, p.adjust = listt$p.adjust, geneID = listt$geneID)
}
...
for (i in 1:5)
{
  ...
  entrez = na.omit(entrez)
  listt = enricher(gene = entrez, TERM2GENE = database, pAdjustMethod = "fdr")
  out.brain_C5[[i]] = data.frame(ID = listt$ID, Description = listt$Description, pvalue = listt$pvalue, p.adjust = listt$p.adjust, geneID = listt$geneID)
}

out.liver_C5 = list(c(), c(), c(), c(), c())
...
for (i in 1:5)
{
  ...
  entrez = na.omit(entrez)
  listt = enricher(gene = entrez, TERM2GENE = database, pAdjustMethod = "fdr")
  out.liver_C5[[i]] = data.frame(ID = listt$ID, Description = listt$Description, pvalue = listt$pvalue, p.adjust = listt$p.adjust, geneID = listt$geneID)
}
...
knitr::kable(first.brain, caption = "Brain TES Protein-Coding Gene: ENSRNOG00000000010")
knitr::kable(second.brain, caption = "Brain TES Protein-Coding Gene: ENSRNOG00000020519")
knitr::kable(third.brain, caption = "Brain TES Protein-Coding Gene: ENSRNOG00000002381")
knitr::kable(fourth.brain, caption = "Brain TES Protein-Coding Gene: ENSRNOG00000016567")
knitr::kable(fifth.brain, caption = "Brain TES Protein-Coding Gene: ENSRNOG00000008176")
...
knitr::kable(first.liver, caption = "Liver TES Protein-Coding Gene: ENSRNOG00000032737")
knitr::kable(second.liver, caption = "Liver TES Protein-Coding Gene: ENSRNOG00000021029")
knitr::kable(third.liver, caption = "Liver TES Protein-Coding Gene: ENSRNOG00000008422")
knitr::kable(fourth.liver, caption = "Liver TES Protein-Coding Gene: ENSRNOG00000002964")
knitr::kable(fifth.liver, caption = "Liver TES Protein-Coding Gene: ENSRNOG00000011973")
