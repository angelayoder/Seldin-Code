...
numtarget_brain = c(s.brain_1top, s.brain_2top, s.brain_3top, s.brain_4top, s.brain_5top, s.brain_6top)

s.liver_1top = s.liver_1[s.liver_1 < 0.05]

fin_brain = data.frame(names_brain, selected_brain[,2], numtarget_brain)

fin_liver = data.frame(names_liver, selected_liver[,2], s.liver_1top)
